...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, disable_radar=False):
    ...
    ret.steerActuatorDelay = 0.15  # 조향 커브 미리 반응속도

    ret.minEnableSpeed = -1
    ret.mass = 1625. + STD_CARGO_KG
    ret.wheelbase = 2.60096
    ret.steerRatio = 16.85  # 조향 힘 반응속도
    ...
    ret.longitudinalTuning.kpV = [1.55, 1.30, 0.65] # when 40 => 1.09, y = 1.38333 - 0.00733333 x,  till 1.20~0.65,
    ...
    ret.longitudinalTuning.kiV = [0.20,0.15, 0.13]   # 롱컨 거리 
